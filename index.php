    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="top-bar row gx-0 align-items-center d-none d-lg-flex">
            ...
            <div class="col-lg-6 px-5 text-end">
                ...
                <a class="text-body ms-3" href="" target="_blank"><i class="fab fa-linkedin-in"></i></a>
    ...
    <div class="container-fluid bg-light bg-icon my-5 py-6">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus, ab inventore. Quisquam ducimus vel sequi aliquam pariatur dolorum voluptas eligendi sit. 
                </p>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corrupti ab sint facere inventore quis, labore optio explicabo numquam aperiam fugit!
                        </p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corrupti ab sint facere inventore quis, labore optio explicabo numquam aperiam fugit!</p>
                        <a class="btn btn-outline-primary border-2 py-2 px-4 rounded-pill" href="">Read More</a>
                    </div>
                </div>
